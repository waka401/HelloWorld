...
.box-header {
	...
	background: linear-gradient(to bottom, rgba(255, 255, 255, 0) 0%,
		rgba(0, 0, 0, 0.1) 100%) repeat scroll 0 0 transparent;
				...
				<form>
					<fieldset>
						<label>用户名</label> <input class="input-xlarge" type="text"
							...
							class="input-xlarge" type="password" placeholder="请输入密码">
				...
				<form class="form-horizontal" id="regForm">
					<fieldset>
						<div class="control-group">
							...
							<div class="controls">
								<input id="regEmail" class="input-xlarge" type="text"
									placeholder="请输入邮箱">
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<input id="regName" class="input-xlarge" type="text"
									placeholder="请输入用户名">
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<input id="regPassword" class="input-xlarge" type="password"
									placeholder="请输入密码">
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<select id="regGender" style="width: 80px">
